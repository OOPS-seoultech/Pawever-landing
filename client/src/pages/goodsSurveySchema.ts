...
export const surveyQuestions: SurveyQuestion[] = [
  ...
  },
  {
    ...
    options: numbered(
      "처음으로 큰 검사나 병원비를 겪었을 때",
      "만성 또는 중증 질환 진단을 들었을 때",
      "입원·수술·응급진료를 경험했을 때",
      "증상 악화와 회복을 반복할 때",
  ...
  },
  {
    ...
    options: numbered(
      "지금을 더 소중하게 보내고 싶었어요",
      "더 잘 돌봐야겠다는 책임감을 느꼈어요",
      "불안하고 무엇을 해야 할지 막막했어요",
      "미안함이나 슬픔이 먼저 들었어요",
  ...
  },
  {
    ...
    options: named(
      ["record", "아이의 일상을 더 자주 관찰하고 기록했어요"],
      ["search", "인터넷·앱·책 등에서 정보를 찾아봤어요"],
      ["consult", "병원이나 주변 사람에게 상담·질문했어요"],
      ["prepare", "상품을 구매하거나 구체적인 준비를 시작했어요"],
      ["none", "특별한 행동을 하지는 않았어요"]
    ),
  },
  {
    id: "q11_1a",
  ...
  },
  {
    ...
    options: numbered(
      ...
      "생각하면 너무 슬프거나 불안했어요",
      "무엇부터 해야 할지 몰랐어요",
      "믿을 만한 정보나 서비스를 찾기 어려웠어요",
      "시간·비용·가족 의견 때문에 미뤘어요"
    ),
  ...
  },
  {
    ...
    options: named(
      ["health_only", "건강·질환 정보만 찾아봤어요"],
      ["future_only", "앞으로의 돌봄·이별 관련 정보만 찾아봤어요"],
      ["health_first", "두 종류를 찾아봤고, 건강·질환 정보가 먼저였어요"],
      [
        "future_first",
        "두 종류를 찾아봤고, 앞으로의 돌봄·이별 정보가 먼저였어요",
      ],
      ["none", "따로 정보를 구체적으로 찾아보진 않았어요"]
    ),
  },
  {
    id: "q14_1h",
  ...
  },
  {
    ...
    options: named(
      ...
      ["aging", "작은 노화 변화를 처음 느꼈을 때"],
      ["signal", "평소와 다른 건강 신호를 처음 봤을 때"],
      ["diagnosis", "질환 진단을 받거나 돌봄이 늘어났을 때"],
      ["later", "솔직히 그보다 나중이거나 설치하고 싶지 않아요"]
    ),
  },
  {
    id: "q21_1",
  ...
  ),
  {
    ...
    options: named(
      ...
      ["never", "어떤 기능이 있어도 건강할 때는 설치하지 않을 거 같아요"]
    ),
  },
  {
    id: "q23_1a",
  ...
  },
  {
    ...
    options: numbered(
      "내가 직접 찾아볼 때만 보여주는 게 좋아요",
      "메뉴는 두되 내가 누르기 전에는 알리지 않으면 좋겠어요",
      "내가 미리 ‘필요할 때 알려 달라’고 설정한 경우만 안내해요",
      "건강 변화나 수의사 설명 등 명확한 계기 뒤에만 안내해요",
      "같은 앱에는 관련 정보가 없는 편이 좋은 거 같아요"
    ),
  },
  {
    id: "q25",
    ...
    section: "D. 부담 없이 시작할 수 있는 서비스",
    title:
      "필요할 때만 돌봄 정보를 받겠습니다'라는 선택지가 있다면 신청하시겠어요?",
    options: numbered(
      "그래도 신청하지 않을 거 같아요",
      "아마 신청하지 않을 거 같아요",
      "잘 모르겠어요",
