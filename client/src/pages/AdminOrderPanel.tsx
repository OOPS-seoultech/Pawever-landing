...
import { AdminError, CopyButton } from "@/components/AdminShell";
import {
  AdminApiError,
  cancelAdminOrder,
 ...
 * 주문 한 건의 상세.
 *
 * 목록의 드로어와 /admin/orders/:orderNumber 가 같은 것을 그린다. 두 벌로
 * 두면 한쪽만 고쳐진다.
 *
 * @param onChanged 무언가 바뀌었을 때. 목록이 자기 숫자를 다시 세도록 알린다.
 */
