...
const DELIBERATE: Record<string, string> = {
  ...
  // 사진 최소 장수를 세 장에서 한 장으로 낮췄다. 세 장을 갖추지 못해 아예
  // 신청하지 못하는 쪽보다 적더라도 받아 만들어 보는 쪽이 낫다는 판단이고,
  // 적게 낸 사람에게는 결과가 달라질 수 있다고 알린 뒤 확인을 받는다.
  "사진 3장 등록하기":
    "장수를 고정해 적지 않는다. 고른 만큼을 버튼이 말한다 — 한 장만 고른 사람에게 세 장이라고 적으면 거짓이 된다.",
  "사진 3장": "최소 세 장을 한 장으로 낮췄다. 화면은 1~5장으로 적는다.",
  "배송비 3,000원 별도 · 사진 3장 제출 · 수작업 검수":
    "같은 이유로 사진 장수만 1~5장으로 바꿔 적는다.",
  "얼굴, 전신, 털색과 무늬가 잘 보이는 사진 3장을 준비해 주세요.":
    "세 장을 요구하지 않는다. 어떤 사진이 좋은지는 그대로 알려 주고 장수만 권유로 바꿨다.",
};
