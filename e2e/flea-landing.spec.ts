 ...
 *
 * 9/9 에 11,900 → 13,900 → 14,900, 9/11 에 18,900 으로 올렸다. 하루 문의가
 * 19건이라 받는 수를 줄이려는 요청에서 시작했다. 피그마는 아직 11,900 과
 * 60.2% 로 그려져 있다.
 */
const FLEA_PRICE = "18,900원";
const LIST_PRICE = "29,900원";
/** 정가에서 내려온 비율. (29,900 - 18,900) / 29,900 */
const FLEA_DISCOUNT = "36.8%";
...
test.describe("플리마켓 랜딩", () => {
  ...
  test("현장 한정가와 수량을 디자인대로 적는다", async ({ page }) => {
    ...
    // 60.2% 를 그대로 두면 29,900원짜리를 18,900원에 팔면서 60.2% 할인이라고
    // 적는 것이 되어 거짓 표시다.
    //
